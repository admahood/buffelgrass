...
lut_species <- c("Cylindropuntia bigelovii" = "Cylindropuntia bigelovii",
                 ...
                 "Ressurection fern" = "resurrection fern",                                                 
                 ...
                 "Pennelia longifolia" = "Pennelia longifolia",                                               
                 ...
                 "Carnegia gigantea" = "Cornegia gigantea",                                                 
                 ...
                 "Cylindropuntia bigelovlii" = "Cylindropuntia bigelovli",                                          
                 "Lycium sp. (2)" = "Lycium sp 2",                                                       
                 "cf. Oroborche cooperi" = "cf. Oroborche cooperi",                                             
                 "Schrophulariaceae sp." = "Unknown dried up cf. Scrophulariaceae",                             
                 "Gutierrezia sarothrae" = "cf. Gutierezia sorothrae",                                          
                 "Xanthisima gracile" = "Xanthisima gracile",                                                
                 ...
                 "Jatropha caridophylla" = "Red-barked shrub w/cottonwood-shaped lvs - Jatropha caridophylla",  
                 "Erodium cicutarium" = "cf. Erodium cicutarium",                                            
                 ...
                 "Sphaerelcea ambigua" = "Sphaerelcea ambigua",                                               
                 "Fern sp. (3)" = "Fern 3",                                                            
                 "Acacia sp. (unarmed)" = "Unarmed acacia",                                                    
                 "Tridens mutica" = "Tridens mutica",                                                    
...
div_input <- read_csv("Diversity - Data.csv") %>%
  replace_na(list(subplot = "plant_walk", percent_cover = 0.2)) %>%
  mutate(unknown_status = NA,
         scientific_name_clean = lut_fixed[species_raw])

write_csv(div_input, "diversity_cleaned.csv")
