...
mod_abundance = Hmsc(Y = A, XData = XData, XFormula = XFormula, distr="probit",
           TrData = traits,
           TrFormula = t_formula,
           studyDesign = studyDesign,
           ranLevels = list("site" = rL))
...
# hmsc_file_a <- "data/hmsc/hmsc_probit_test_abundance.Rda"
...
ggsave("figs/betas_binomial.png", bg="white", width=6, height=8)
...
ggsave(grazing_native, filename = "figs/gradient_peci_cover.png", width = 20, height = 15)
